...
app.get('/api/search', async (req, res) => {
    ...
    if (localMatch) {
        ...
        const deployment = localMatch.deployments && localMatch.deployments[0] ? localMatch.deployments[0] : {};
        const finalAddress = localMatch.native_identifier && localMatch.native_identifier !== "0x0000000000000000000000000000000000000000"
            ? localMatch.native_identifier
